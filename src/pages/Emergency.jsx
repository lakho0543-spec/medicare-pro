...
import {
  ...
  PhoneCall, PhoneForwarded, PhoneIncoming, PhoneOutgoing,
  Car, Navigation2, Map, Compass, Flag, Home,
  Smartphone, Tablet, Watch, WifiOff, Bluetooth,
  Radio, Satellite, Cloud, CloudOff, CloudRain,
  CloudSnow, CloudLightning, Wind, Sun, Moon,
  Sunrise, Sunset, ThermometerSun, ThermometerSnowflake,
  Droplets, Umbrella, Wind as WindIcon,
  Building2, // Using Building2 instead of Hospital
  HeartPulse, // Using HeartPulse for medical
...
export default function Emergency() {
  ...
  // Custom Siren component since it's not in lucide-react
  const Siren = (props) => (
    <svg
      {...props}
  ...
  const emergencyTypes = [
    ...
    { id: 'breathing', name: 'Breathing', icon: WindIcon, color: 'from-cyan-500 to-blue-600', priority: 'high' },
    { id: 'bleeding', name: 'Bleeding', icon: Droplets, color: 'from-red-600 to-pink-600', priority: 'high' },
    { id: 'burn', name: 'Burn', icon: ThermometerSun, color: 'from-yellow-500 to-orange-600', priority: 'medium' },
  ...
  const emergencyContacts = [
    ...
    { name: 'Ambulance', number: '115', type: 'ambulance', icon: Ambulance },
    { name: 'Rescue', number: '1122', type: 'rescue', icon: Users },
    { name: 'Police', number: '15', type: 'police', icon: Shield },
    { name: 'Fire Brigade', number: '16', type: 'fire', icon: ThermometerSun },
  ...
  const requestAmbulance = (service) => {
      ...
      <section className="relative pt-32 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 25px 25px, rgba(239, 68, 68, 0.2) 2%, transparent 0%),
                              radial-gradient(circle at 75px 75px, rgba(239, 68, 68, 0.2) 2%, transparent 0%)`,
                    ...
                    {emergencyTypes.map((type) => (
                      ...
                      >
                        ...
                        <div className={`text-xs mt-1 px-2 py-1 rounded-full inline-block ${
                          type.priority === 'critical' ? 'bg-red-900/30 text-red-400' :
                          type.priority === 'high' ? 'bg-orange-900/30 text-orange-400' :
                    ...
                    {emergencyContacts.map((contact, index) => (
                      ...
                      >
                        <div className={`p-3 rounded-xl mr-4 ${
                          ...
                          contact.type === 'ambulance' ? 'bg-orange-600/20 text-orange-400' :
              ...
              >
                ...
                <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    >
                      <Ambulance className="h-6 w-6 text-orange-400 mb-2" />
                    ...
                    <button className="p-4 rounded-xl bg-purple-600/20 border border-purple-600/30 hover:bg-purple-600/30 flex flex-col items-center justify-center">
                      ...
                      >
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex space-x-3">
                            <button
                              onClick={() => callEmergency(hospital.contact)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8">
                    ...
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                        <span>Know your location and address</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                        <span>Keep medical history accessible</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1 flex-shrink-0" />
                        <span>Have basic first aid kit ready</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-3xl p-8">
                    ...
                    <div className="space-y-4">
                      <button className="w-full py-3 bg-gradient-to-r from-red-600 to-orange-600 rounded-xl hover:shadow-lg flex items-center justify-center space-x-3">
        ...
        {showAmbulanceModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-gray-900 border border-gray-700 rounded-3xl shadow-2xl z-50 p-8"
            >
              <div className="flex items-center justify-between mb-8">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl focus:outline-none focus:border-red-500">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl focus:outline-none focus:border-red-500 h-32"
                  />
                </div>
                
                <button
                  onClick={() => {
                    requestAmbulance(ambulanceServices[0]);
                    setShowAmbulanceModal(false);
                  }}
